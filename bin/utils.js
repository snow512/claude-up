 ...
 */
function syncDirectory(srcDir, dstDir, force, fileFilter) {
    const empty = { counts: { created: 0, updated: 0, unchanged: 0 }, reports: [] };
    let files;
    try {
    ...
    const outcome = { counts: { created: 0, updated: 0, unchanged: 0 }, reports: [] };
